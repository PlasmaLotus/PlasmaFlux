	...
	joystickMaxZone(60.f)
{
	...
	keyMap[sf::Keyboard::Key::X] = ControllerCommand::Action;
	keyMap[sf::Keyboard::Key::Z] = ControllerCommand::Jump;
	keyMap[sf::Keyboard::Key::F4] = ControllerCommand::Cheat;
	keyMap[sf::Keyboard::Key::A] = ControllerCommand::Jump;
	keyMap[sf::Keyboard::Key::S] = ControllerCommand::Action;

	buttonMap[0] = ControllerCommand::Action;
	buttonMap[1] = ControllerCommand::Action;
	buttonMap[2] = ControllerCommand::Action;
	buttonMap[4] = ControllerCommand::Jump;
	buttonMap[5] = ControllerCommand::Jump;
